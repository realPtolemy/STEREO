 ...
 * @param The vector to add to this one */
   ...
   */
		...
		TF2SIMD_FORCE_INLINE	void	serializeFloat(struct	Vector3dloatData& dataOut) const;

		TF2SIMD_FORCE_INLINE	void	deSerializeFloat(const struct	Vector3dloatData& dataIn);
...
TF2SIMD_FORCE_INLINE	void	Vector3::serializeFloat(struct	Vector3dloatData& dataOut) const
{
...
TF2SIMD_FORCE_INLINE void	Vector3::deSerializeFloat(const struct	Vector3dloatData& dataIn)
{
	for (int i=0;i<4;i++)
