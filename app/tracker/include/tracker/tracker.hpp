...
//     std::vector<tf2::msg::TransformStamped> poses_;           // estimated poses
//     std::vector<tf2::msg::TransformStamped> poses_filtered_;  // median filtered poses
...
//      */
//     void mapCallback(const pcl::PointCloud<pcl::PointXYZI>::Ptr& msg);
//     /**
...
//      */
//     // lägg std::string i en smart_pointer?
//     void remoteCallback(const std::string& msg);
//     /**
...
//      * @see updateMap
//      */
//     void initialize(const tf2::TimePoint& ts);
...
//      */
//     bool getFilteredPose(tf2::msg::TransformStamped& pose);
